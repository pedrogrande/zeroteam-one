...
Source materials: [https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering](https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering) 
...
"Sub-agents exist primarily to isolate context rather than to simulate organizational roles." — multi-agent-patterns SKILL.md
...
Research shows tool observations can reach **83.9% of total context usage**. The scratch pad pattern in filesystem\_context.py offloads large outputs and returns file references, keeping agent context lean. Anthropic restricts tool responses to **25,000 tokens by default** in Claude Code.
